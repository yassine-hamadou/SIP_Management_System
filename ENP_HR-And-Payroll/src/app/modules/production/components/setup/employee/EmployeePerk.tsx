...
const EmployeePerks = () => {
  ...
  const deleteData = async (element: any) => {
    try {
      const response = await axios.delete(`${Api_Endpoint}/EmployeePerks/${element.id}`)
  ...
  const loadData = async () => {
    setLoading(true)
    try {
      const response = await axios.get(`${Api_Endpoint}/EmployeePerks`)
  ...
  const url = `${Api_Endpoint}/EmployeePerks`
