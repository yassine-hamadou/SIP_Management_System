...
import { Api_Endpoint, updateCategory } from '../../../../../services/ApiCalls'
...
const Categories = () => {
  ...
  const { isLoading, mutate } = useMutation(updateCategory, {
    onSuccess: (data) => {
      queryClient.setQueryData(['category', tempData.id], data);
      reset()
      setTempData({})
      loadData()
      setIsUpdateModalOpen(false)
