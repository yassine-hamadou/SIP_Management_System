...
import { RECRUITMENTS } from '../../../../../data/DummyData'
import { useForm } from 'react-hook-form'
import { Api_Endpoint, updateRecruitment } from '../../../../../services/ApiCalls'
...
const Recruitments = () => {
  ...
  const deleteData = async (element: any) => {
    try {
      const response = await axios.delete(`${Api_Endpoint}/Recruitments/${element.id}`)
  ...
  const { isLoading, mutate } = useMutation(updateRecruitment, {
    onSuccess: (data) => {
      queryClient.setQueryData(['recruitment', tempData.id], data);
      reset()
      setTempData({})
      loadData()
      setIsUpdateModalOpen(false)
  ...
  const url = `${Api_Endpoint}/Recruitments`
