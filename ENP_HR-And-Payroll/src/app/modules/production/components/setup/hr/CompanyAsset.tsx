...
import { Api_Endpoint, updateCompanyAssets } from '../../../../../services/ApiCalls'
...
const CompanyAsset = () => {
  ...
  const deleteData = async (element: any) => {
    try {
      const response = await axios.delete(`${Api_Endpoint}/CompanyAssets/${element.id}`)
  ...
  const { isLoading, mutate } = useMutation(updateCompanyAssets, {
    onSuccess: (data) => {
      queryClient.setQueryData(['CompanyAssets', tempData.id], data);
      reset()
      setTempData({})
      loadData()
      setIsUpdateModalOpen(false)
  ...
  const url = `${Api_Endpoint}/CompanyAssets`
