...
import { Api_Endpoint, updateItem, updateNoteCategory, updatePerk } from '../../../../../services/ApiCalls'
...
const Notes = () => {
  ...
  const { isLoading, mutate: PutNoteCategory } = useMutation(updateNoteCategory , {
    onSuccess: (data) => {
