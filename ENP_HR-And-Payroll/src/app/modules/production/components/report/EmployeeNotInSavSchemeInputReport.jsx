...
constructor(props) {
    super(props);
    this.reportUrl = ko.observable("EmployeeNotInSavSchemeInputReport");
    this.requestOptions = {
...
function EmployeeNotInSavSchemeInputReport() {
return (<div style={{ width: "100%", height: "1000px" }}>
    <ReportViewer />
</div>);
}
export default EmployeeNotInSavSchemeInputReport;