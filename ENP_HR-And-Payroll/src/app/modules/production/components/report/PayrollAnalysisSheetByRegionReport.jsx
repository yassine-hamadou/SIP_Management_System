...
constructor(props) {
    super(props);
    this.reportUrl = ko.observable("PayrollAnalysisSheetByRegionReport");
    this.requestOptions = {
...
function PayrollAnalysisSheetByRegionReport() {
return (<div style={{ width: "100%", height: "1000px" }}>
    <ReportViewer />
</div>);
}
export default PayrollAnalysisSheetByRegionReport;