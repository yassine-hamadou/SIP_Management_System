...
constructor(props) {
    super(props);
    this.reportUrl = ko.observable("EmployeeNotInDeductionInputReport");
    this.requestOptions = {
...
function EmployeeNotInDeductionInputReport() {
return (<div style={{ width: "100%", height: "1000px" }}>
    <ReportViewer />
</div>);
}
export default EmployeeNotInDeductionInputReport;